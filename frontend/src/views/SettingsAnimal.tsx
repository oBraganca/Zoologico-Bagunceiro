...
const SettingsAnimal = () =>{
    ...
    useEffect(() => {
        ...
        axios.get('http://127.0.0.1:8000/api/animals/'+authUser.currentUser.id,config ).then((res) => {
    ...
    const handleSubmit = async (e:React.SyntheticEvent<HTMLFormElement>) => {
        ...
        if(checked){
            ...
            try {
                axios.put('http://127.0.0.1:8000/api/animals/settings/'+authUser.currentUser.id,data, config).then((res) => {
                    dispatch({
                        type: 'AUTHENTICATED', 
                        payload:{
                    ...
                    <Grid container spacing={1}>
                        ...
                        <Grid item xs={12} style={{display:'flex'}}>
                            <Grid item xs={6} sx={{display:'flex',flexDirection: 'column'}}>
                                ...
                                <Typography sx={{marginTop:'0.7rem'}} variant="h5" color="text.primary">Settings Profile</Typography>
                            </Grid>
